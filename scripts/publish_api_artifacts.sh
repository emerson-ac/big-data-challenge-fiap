...
#
#   s3://$MODELS_BUCKET/$S3_PREFIX/models/...          (item_similarity, ranking, etc.)
#   s3://$MODELS_BUCKET/$S3_PREFIX/data/processed/...  (vocabularies, interactions)
#
...
# Só os artefatos consumidos por src/models/inference.py (RecommendationEngine).
required=(
